...
ecritureOkKo : async function (nombre_ok_ko, table,date_export,mois1,callback) {
  ...
  ecritureOkKoSante : async function (nombre_ok_ko, table,date_export,mois1,callback) {
    ...
    /***************************************************************/
    ecritureOkKoSantece : async function (nombre_ok_ko, table,date_export,mois1,callback) {
      const Excel = require('exceljs');
      const cmd=require('node-cmd');
      const newWorkbook = new Excel.Workbook();
    ...
    /***************************************************************/
  ecritureOkKoSantecf : async function (nombre_ok_ko, table,date_export,mois1,callback) {
    const Excel = require('exceljs');
    const cmd=require('node-cmd');
    const newWorkbook = new Excel.Workbook();
