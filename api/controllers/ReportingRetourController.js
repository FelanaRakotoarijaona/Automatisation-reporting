                      ...
                      function (callback) {
                        ...
                        function (callback) {
                          ...
                          //   },
                            ...
                            if(resultExcel[0]=='OK' || resultExcel[1]== 'OK' || resultExcel[2]== 'OK'  || resultExcel[3]== 'OK' || resultExcel[4]== 'OK' || resultExcel[5]== 'OK' || resultExcel[6]== 'OK' || resultExcel[7]== 'OK' || resultExcel[8]== 'OK' || resultExcel[9]== 'OK' || resultExcel[10]=='OK' || resultExcel[11]== 'OK' || resultExcel[12]=='OK')
                            {
                              async.series([
                                function(cb){
...
/********************************************/
rechercheColonne_suivant : async function (req, res) {
  const fs = require('fs');
      try {
        await fs.promises.open('/dev/prod/00-TOUS/TestReporting/REPORTING INOVCOM Type.xlsx', 'r+');
...
rechercheColonnetest : function (req, res) {
 ...
 //AJOUT FONCTION RECHERCHECOLONNE POUR RETOUR
 rechercheColonne_2 : async function (req, res) {
  const fs = require('fs');
  try {
    await fs.promises.open('/dev/prod/00-TOUS/TestReporting/REPORTING INOVCOM Type.xlsx', 'r+');
